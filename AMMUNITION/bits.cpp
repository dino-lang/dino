/*
   ...
   TITLE:       Implementation of class for work with bits

   DESCRIPTION: This file implements class for work with bit strings.
       A bit is given by address (start address) of byte from which
       counting bits starts and its displacement which is any non
       negative number of bit from the start address.  The most
       significant bit of the start address byte has number 0.  The
       bit string is given by its first bit and its length in bits.
...
int
bits::is_zero_bit_string (const void *start_byte, int bit_displacement,
                          int bit_length)
{
  const unsigned char *current_byte = (unsigned char *) start_byte;
...
void
bits::bit_string_set (void *start_byte, int bit_displacement, int bit,
                      int bit_length)
{
...
void
bits::bit_string_copy (void *to, int to_bit_displacement,
                       const void *from, int from_bit_displacement,
                       int bit_length)
{
  unsigned char *current_to_byte = (unsigned char *) to;
  const unsigned char *current_from_byte = (unsigned char *) from;
  int byte;
  int mask;
...
void
bits::bit_string_move (void *to, int to_bit_displacement,
                       const void *from, int from_bit_displacement,
                       int bit_length)
{
  unsigned char *current_to_byte = (unsigned char *) to;
...
int
bits::bit_string_comparison (const void *str1, int bit_displacement1,
                             const void *str2, int bit_displacement2,
                             int bit_length)
{
  const unsigned char *current_byte1 = (unsigned char *) str1;
  const unsigned char *current_byte2 = (unsigned char *) str2;
  int byte1;
  int byte2;
  int mask;
