...
extern int start_command_line_processing (int argc, char **argv, const char *description);
...
extern char *option_characteristics (int argument_number, int *option_has_argument);
