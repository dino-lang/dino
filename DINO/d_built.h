...
extern void translit_call (int_t pars_number);
extern void eltype_call (int_t pars_number);
extern void keys_call (int_t pars_number);
extern void closure_call (int_t pars_number);
...
extern void fuidn_call (int_t pars_number);
extern void fgrpn_call (int_t pars_number);
