	       ...
	       void **first_hidevalue)
{
  ...
  var1 = IVAL (ER_stack_vars (ER_stack ((ER_node_t) (vals + 1))), 1);
  var2 = IVAL (ER_stack_vars (ER_stack ((ER_node_t) (vals + 2))), 1);
  first_var = IVAL (ER_stack_vars (ER_stack ((ER_node_t) vals)), 1);
...
mpz_two_op (int npars, val_t *vals, void **hidevalue, void **first_hidevalue)
{
  ...
  d_assert (npars == 2
	    && ER_NODE_MODE ((ER_node_t) vals) == ER_NM_stack
	    && ER_NODE_MODE ((ER_node_t) (vals + 1)) == ER_NM_stack);
  var = IVAL (ER_stack_vars (ER_stack ((ER_node_t) (vals + 1))), 1);
  first_var = IVAL (ER_stack_vars (ER_stack ((ER_node_t) vals)), 1);
...
_z_set_str (int npars, val_t *vals)
{
  ...
  res_var = IVAL (ER_stack_vars (ER_stack ((ER_node_t) vals)), 1);
