...
char ERR_source_file_encoding[] = "unknown or not implemented encoding `%s' of file `%s'";
...
char ERR_wrong_hint_for_non_fun[] = "inline or pure hint is permitted only for fun";
char ERR_jit_hint_for_fiber[] = "jit hint is not permitted for fiber";
char ERR_default_value_parameter_and_dots[] = "usage of parameter default value and `...'";
...
char ERR_segment_access_violation_exception[] = "segment access violation";
...
char ERR_previous_decl_location[] = "(previous declaration of identifier `%s')";
...
char ERR_vec_tab_element_access_applied_to_slice[] = "`[...]' is applied to slice";
...
char ERR_table_dots_as_key_with_value[] = "`...' as key with value in the table pattern";
char ERR_assignment_pattern_without_variables[] = "Pattern in assignment has no variables";
char ERR_invalid_friend[] = "friend identifier `%s' is neither function nor class";
char ERR_no_public_declaration_in_object[] = "no public declaration `%s' in the object";
char ERR_non_object_in_expose_clause[] = "non object in exposing object internals";
...
char ERR_use_of_forward_declaration[] = "use of forward declaration of fun/class `%s'";
char ERR_use_of_final[] = "use of final fun/class `%s'";
char ERR_use_of_class_inside_the_class[] = "use of fun/class `%s' inside the fun/class";
char ERR_repeated_use_item_ident_occurence_in_use[]
  = "repeated occurrence of identifier `%s' in use items";
char ERR_previous_use_item_ident_location[] = "(previous occurrence of identifier `%s')";
char ERR_undefined_use_item_ident[] = "identifier `%s' is not found in the corresponding class/fun";
...
char ERR_ident_in_former_has_no_prev_decl[] = "ident `%s' in former item has no previous decl";
char ERR_used_decl_redefinition_not_mentioned_in_later[]
  = "`%s' redefines an used decl not mentioned in later item";
char ERR_here_is_corresponding_use_clause[] = "here is the corresponding use clause for `%s'";
...
char ERR_decl_is_absent_in_a_block[] = "there is no such declaration in a block";
char ERR_invalid_type_of_arrow_left_operand[] = "left operand of arrow must be of string type";
char ERR_invalid_type_of_deref_operand[] = "operand of unary `*' must be of string type";
char ERR_invalid_logical_operation_operand_type[] = "invalid type of operand in logical operation";
...
char ERR_invalid_fold_arithmetic_operation_operand_type[]
  = "invalid operand type in (.+, .*, .|, .^, .&)";
char ERR_invalid_fold_concat_operation_operand_type[] = "invalid operand type in .@";
char ERR_invalid_repetition_type[] = "invalid type of repetition in vector (`[...]')";
char ERR_invalid_length_operand_type[] = "invalid operand type in length operation `#'";
char ERR_invalid_conversion_to_char_operand_type[] = "invalid operand type in char (...)";
char ERR_invalid_conversion_to_int_operand_type[] = "invalid operand type in int (...)";
char ERR_invalid_conversion_to_long_operand_type[] = "invalid operand type in long (...)";
char ERR_invalid_conversion_to_float_operand_type[] = "invalid operand type in float (...)";
char ERR_invalid_conversion_to_vector_operand_type[] = "invalid operand type vec (...)";
char ERR_invalid_conversion_format_type[] = "invalid format type in vec (...)";
char ERR_invalid_conversion_to_table_operand_type[] = "invalid operand type tab (...)";
char ERR_invalid_cond_type[] = "invalid conition type in conditional expression (`...?...:...')";
char ERR_invalid_vec_slice_type[] = "invalid type of vector in slice access (`[...]')";
char ERR_invalid_vec_tab_type[] = "invalid type of vec/tab in elements access (`[...]')";
char ERR_invalid_tab_type[] = "invalid type of table in table elements access `in'";
char ERR_invalid_slice_start_type[] = "invalid type of start in vector slice access (`[:]')";
char ERR_invalid_slice_bound_type[] = "invalid type of bound in vector slice access (`[:]')";
char ERR_invalid_slice_step_type[] = "invalid type of step in vector slice access (`[:]')";
...
char ERR_non_variable_in_assignment[] = "non variable in assignment statement";
...
char ERR_non_variable_in_foreach_index[] = "non variable in foreach-stmt index designator";
...
char ERR_return_outside_fun_class[] = "statement return is not in function or class";
char ERR_return_with_result_in_class[] = "statement return with result is in class";
char ERR_return_with_result_in_fiber[] = "statement return with result is in fiber";
char ERR_function_call_in_wait_stmt[] = "function call is present in wait statement";

/* Byte code specific errors:  */
char ERR_byte_code_should_start_with_label[] = "byte code should start with label";
char ERR_byte_code_should_have_name[] = "byte code should have name";
char ERR_byte_code_field_should_have_name[] = "byte code field should have name";
char ERR_byte_code_field_should_be_followed_by_eq[] = "byte code field should be followed by eq";
...
/* Execution errors:  */
char DERR_environment_corrupted[] = "run time error - environment has been corrupted";
...
char DERR_logical_and_operands_types[]
  = "run time error - invalid types of operands of operator \"&&\"";
char DERR_cond_operand_type[] = "run time error - invalid type of condition in operator \"? :\"";
char DERR_not_operand_type[] = "run time error - invalid type of operand of operator \"!\"";
char DERR_bitwise_not_operand_type[] = "run time error - invalid type of operand of operator \"~\"";
char DERR_lt_operands_types[] = "run time error - invalid types of operands of operator \"<\"";
char DERR_gt_operands_types[] = "run time error - invalid types of operands of operator \">\"";
char DERR_le_operands_types[] = "run time error - invalid types of operands of operator \"<=\"";
char DERR_ge_operands_types[] = "run time error - invalid types of operands of operator \">=\"";
char DERR_plus_operands_types[] = "run time error - invalid types of operands of operator \"+\"";
char DERR_minus_operands_types[]
  = "run time error - invalid types of operands of binary operator \"-\"";
char DERR_concat_operands_types[] = "run time error - invalid types of operands of operator \"@\"";
char DERR_mult_operands_types[] = "run time error - invalid types of operands of operator \"*\"";
char DERR_div_operands_types[] = "run time error - invalid types of operands of operator \"/\"";
char DERR_mod_operands_types[] = "run time error - invalid types of operands of operator \"%\"";
char DERR_lshift_operands_types[] = "run time error - invalid types of operands of operator \"<<\"";
char DERR_rshift_operands_types[] = "run time error - invalid types of operands of operator \">>\"";
char DERR_ashift_operands_types[]
  = "run time error - invalid types of operands of operator \">>>\"";
char DERR_and_operands_types[] = "run time error - invalid types of operands of operator \"&\"";
char DERR_xor_operands_types[] = "run time error - invalid types of operands of operator \"^\"";
char DERR_or_operands_types[] = "run time error - invalid types of operands of operator \"|\"";
...
char DERR_unary_minus_operand_type[]
  = "run time error - invalid type of operand of unary operator \"-\"";
char DERR_length_operand_type[] = "run time error - invalid type of operand of operator \"#\"";
...
char DERR_vector_conversion_format_type[] = "run time error - invalid type of format of vec (...)";
char DERR_conversion_to_table_operand_type[]
  = "run time error - invalid type of operand of tab (...)";
char DERR_elist_repetition_type[] = "run time error - invalid type of repetition";
char DERR_invalid_if_expr_type[] = "run time error - invalid if-expression type";
char DERR_invalid_for_guard_expr_type[] = "run time error - invalid for-guard expression type";
char DERR_invalid_wait_guard_expr_type[] = "run time error - invalid wait-guard expression type";
char DERR_wait_in_sync_stmt[] = "wait in sync-statement";
char DERR_fiber_call_in_sync_stmt[] = "fiber call in sync-statement";
char DERR_no_exception_after_throw[] = "run time - an except instance must be after throw";
char DERR_index_is_not_int[] = "run time error - index is not integer";
char DERR_index_is_negative_number[] = "run time error - index is negative number";
...
char DERR_slice_start_is_not_int[] = "run time error - slice start is not integer (dimension = %d)";
char DERR_slice_bound_is_not_int[] = "run time error - slice bound is not integer (dimension = %d)";
char DERR_slice_step_is_not_int[] = "run time error - slice step is not integer (dimension = %d)";
char DERR_slice_start_is_negative[] = "run time error - slice start is negative (dimension = %d)";
char DERR_slice_step_is_zero[] = "run time error - slice step is zero (dimension = %d)";
char DERR_different_slice_operand_lengths[]
  = "run time error - different lengths of slices %ld vs %ld (dimension = %d)";
char DERR_slice_operand_form[] = "run time error - slice to wrongly formed vector (dimension = %d)";
char DERR_different_vec_operand_lengths[]
  = "run time - different vector operand lengths: %ld vs. %ld (dimension = %d)";
char DERR_vector_form_type[] = "run time error - wrong vector form for vector operation";
char DERR_matrix_form_type[] = "run time error - wrong matrix form for matrix operation `%s'";
char DERR_repeated_key[] = "run time error - repeated key #%lld in the table  (`tab [...]')";
char DERR_no_such_key[] = "run time error - no such key in table";
char DERR_in_table_operand_type[] = "run time error - non table right to `in'";
char DERR_unfinished_fun_class_call[] = "run time error - unfinished fun/class `%s' call";
char DERR_none_class_or_fun_before_left_bracket[]
  = "run time error - none class or function is before \"(\"";
char DERR_parameter_type[] = "run time error - invalid parameter type of `%s'";
char DERR_parameter_value[] = "run time error - invalid parameter value for `%s'";
char DERR_invalid_result[] = "run time error - invalid function result used by function `%s'";
;
char DERR_invalid_input[] = "run time error - invalid input read by function `%s'";
;
...
char DERR_in_ucode_encoding[] = "run time error - wrong unicode for encoding used by `%s'";
...
char DERR_eof_occured[] = "run time error - EOF occured in `%s'";
char DERR_parameters_number[] = "run time error - unexpected number of parameters for `%s'";
char DERR_too_few_actual_parameters[] = "run time error - too few actual parameters for `%s'";
char DERR_too_many_actual_parameters[] = "run time error - too many actual parameters for `%s'";
...
char DERR_enotty[] = "system error - inappropriate I/O control operation: `%s'";
...
char DERR_no_shell[] = "run time error - no shell found during call of `system'";
char DERR_other_fail_in_system_call[] = "run time error - fail during call of `system'";
char DERR_regex[] = "run time Oniguruma error in `%s' - %s";
char DERR_no_such_external[] = "run time error - can not find external function %s";
char DERR_library_close_error[] = "run time error - closing library %s";
char DERR_no_support_extern_funcs[]
  = "run time error - there is no support of external functions on the host";
char DERR_corrupted_environment_var[] = "run time error - bad value of environment variable `%s'";
char DERR_internal_error[] = "run time error - internal error in `%s'";
char DERR_fun_as_variable[] = "run time error - usage function as variable";
char DERR_class_as_variable[] = "run time error - usage class as variable";
...
char DERR_undefined_value_access[] = "run time error - undefined `%s' value access";
char DERR_undefined_value_assign[] = "run time error - undefined value assign";
char DERR_private_decl_access_from_outside_block[]
  = "run time error - access to private decl `%s' from outside";
char DERR_undefined_class_or_fun[] = "run time error - undefined class or function `%s'";
char DERR_immutable_vector_modification[] = "run time error - attempt to modify immutable vector";
char DERR_immutable_table_modification[] = "run time error - attempt to modify immutable table";
char DERR_immutable_instance_modification[]
  = "run time error - attempt to modify immutable instance";
char DERR_wrong_vector_pattern_match[] = "run time error - expr does not match vector pattern";
char DERR_wrong_table_pattern_match[] = "run time error - expr does not match table pattern";
char DERR_wrong_stack_pattern_match[] = "run time error - expr does not match stack pattern";
char DERR_rmatch_expr_type[] = "run time error - rmatch expression is not a string";
char DERR_rmatch_case_expr_type[] = "run time error - rmatch case expression is not a string";
;
char DERR_deadlock[] = "run time error - thread deadlock";
char DERR_unprocessed_exception[] = "run time error - exception %s has not been processed";
char DERR_C_code_compilation_failure[] = "run time error - failure to compile the C code";
