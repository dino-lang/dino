/*
   ...
   TITLE:       Include file of OKA (pipeline hazards description translator)
                tables
...
extern IR_node_t insert_single_automaton_declaration
                    (IR_node_t single_automaton_declaration);
extern IR_node_t find_single_automaton_declaration (IR_node_t identifier);

extern void initiate_single_automaton_declaration_table (void);
extern void finish_single_automaton_declaration_table (void);
